    ...
    class o {
        ...
        parseData(a) {
            ...
            for (this.segments = []; !d.isType(this.EOD);) {
                var f, g = [];
                if (!("BOD" == e)) d.isType(this.NUMBER) ? f = this.PARAMS[e].length : (c++, f = this.PARAMS[d.text].length, e = d.text);
                ...
                case "a":
                    {
                        ...
                        if (7 <= b.data.length) {
                            ...
                            if (0 == f || 0 == g) e = e.concat(this._doubleLine(a.x, a.y, k, l, d)), a.setPosition(k, l);
                            else {
                ...
                case "path2Dfill":
                    {
                        ...
                        let a = new Path2D(e.path);this.ctx.fill(a),
                        this.ctx.restore();
                        break
                    }
                case "path2Dpattern":
